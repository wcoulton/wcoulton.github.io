...
(function(d){d.fn.poptrox_disableSelection=function(){return d(this).css("user-select","none").css("-khtml-user-select","none").css("-moz-user-select","none").css("-o-user-select","none").css("-webkit-user-select","none")};d.fn.poptrox=function(v){function z(){A=d(window).width();w=d(window).height()+a.windowHeightPad}if(1<this.length){for(var h=0;h<this.length;h++)d(this[h]).poptrox(v);return d(this)}var a=d.extend({preload:!1,baseZIndex:1E3,fadeSpeed:300,overlayColor:"#000000",overlayOpacity:0.0,
